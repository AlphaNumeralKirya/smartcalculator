...
// smartcalculator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CsmartcalculatorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CsmartcalculatorApp

CsmartcalculatorApp::CsmartcalculatorApp()
{
...
// Единственный объект CsmartcalculatorApp

CsmartcalculatorApp theApp;


// Инициализация CsmartcalculatorApp

BOOL CsmartcalculatorApp::InitInstance()
{
